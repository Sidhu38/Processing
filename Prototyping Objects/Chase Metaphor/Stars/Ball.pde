class Ball {
  ...
  public Ball(float widthParameter, float heightParameter) { //Passsing Geometry
    ...
    ballDiameter = int(widthParameter/70); //need a procedure for this or a choice of code
  ...
  private void gamePlay() {
    ...
    //Ball 
    if (ballXLeftGoal == true || ballXRightGoal == true) { //EMPTY IF 
    } else {
  ...
  Boolean ballLeftGoalGetter() { //Score 
    return ballXLeftGoal;
  }
  Boolean ballRightGoalGetter() { //Score
